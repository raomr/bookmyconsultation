...
public class DoctorService {
	...
	public Doctor register(Doctor doctor) throws InvalidInputException{
		...
		addressToUpdate.setId(doctor.getId());
		addressToUpdate.setAddressLine1(doctor.getAddress().getAddressLine1());
		addressToUpdate.setAddressLine2(doctor.getAddress().getAddressLine2());
		addressToUpdate.setCity(doctor.getAddress().getCity());
		addressToUpdate.setState(doctor.getAddress().getState());
		addressToUpdate.setPostcode(doctor.getAddress().getPostcode());
